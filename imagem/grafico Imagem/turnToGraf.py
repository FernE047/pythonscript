...
for aheight in range(0,meio[1]+1):
    ...
    draw.line((meio[0],meio[1], 0,aheight), fill=(0,0,0,255),width=1)   #(firstX,firstY,secondX,secondY)
    altGraf=0
    if(aheight%50==0):
        print(str(aheight))
...
for awidth in range(0,meio[0]+1):
    lineImage=Image.new('RGBA',(width,height),(255,255,255,255))
    draw = ImageDraw.Draw(lineImage)
    draw.line((meio[0],meio[1], awidth,height-1), fill=(0,0,0,255),width=1)   #(firstX,firstY,secondX,secondY)
    altGraf=0
    if(awidth%50==0):
        print(str(awidth))
        imageGraf.save("imagesgraf"+imagemNumber+".jpg")
...
for aheight in range(height-1,meio[1]-1,-1):
    lineImage=Image.new('RGBA',(width,height),(255,255,255,255))
    draw = ImageDraw.Draw(lineImage)
    draw.line((meio[0],meio[1],width-1,aheight), fill=(0,0,0,255),width=1)   #(firstX,firstY,secondX,secondY)
    altGraf=0
    if(aheight%50==0):
        print(str(aheight))
        imageGraf.save("imagesgraf"+imagemNumber+".jpg")
...
for awidth in range(width-1,meio[0]-1,-1):
    lineImage=Image.new('RGBA',(width,height),(255,255,255,255))
    draw = ImageDraw.Draw(lineImage)
    draw.line((meio[0],meio[1], awidth,0), fill=(0,0,0,255),width=1)   #(firstX,firstY,secondX,secondY)
    altGraf=0
    if(awidth%50==0):
        print(str(awidth))
        imageGraf.save("imagesgraf"+imagemNumber+".jpg")
