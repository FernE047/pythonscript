...
tiposCat=['Normal','Fire','Water','Grass','Ice','Dark','Steel','Electric','Fighting','Poison','Ground','Flying','Psychic','Bug','Rock','Ghost','Dragon','Fairy']
soma={}
soma['type']={}
for tipo in tiposCat:
    soma['type'][tipo]=0
categorias=['male rate','female rate','height','weight lbs','weight kg','capture rate','base egg steps','alola','quantia tipo','genderless','mega']
total=0
